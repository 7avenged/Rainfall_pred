#LOAD THE MODULES##                                              #THIS ONE DECISION TREE REGRESSION ONLY
...
plt.title('[DTR]: RAINFALL STATISTICS')
plt.legend()
plt.grid(True)
...
print("THE PREDICTED RAINFALL IN THE MONTH OF month IN THE YEAR  year IS: ")
print(y_1)
...
plt.scatter(X, Y, s=20, edgecolor="black",
            c="darkorange", label="data")
plt.plot(X1, opY, color="cornflowerblue",
         label="[DTR] fitting, max_depth=120", linewidth=2)
#plt.plot(X, y_2, color="yellowgreen", label="max_depth=5", linewidth=2)
plt.xlabel("RAINFALL IN THAT MONTH OVER THE YEARS")
plt.ylabel("THE YEARS-> 1901-2015")
plt.title('[DTR]: RAINFALL STATISTICS')
